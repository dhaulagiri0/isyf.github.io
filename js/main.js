...
var names = [['Jerry', 'Weihan', 'Shao Jun', 'Bernard', 'Sean', 'Jiaqi', 'Jadie', 'Xiao En'], ['Stefanie', 'See Min', 'Beatrice', 'Celeste', 'Joel', 'Jing Heng', 'Wenhao', 'Wei Sheng', 'Ruoxin', 'Weiting', 'Levina', 'Qiyu'], ['Rachael', 'Alson', 'Zhiheng', ' Huiyan', 'Brandon', 'Xavier'], ['Wei Shuen', 'Yiqin', ' Junwei', 'Mavryk', 'Rae Ann', 'Ee Hseun', 'Nanette', 'Yihan']]
var facilGroup = [['Draco', 'Equuleus', 'Lyra', 'Hercules', 'Columba', 'Monoceros', 'Orion', 'Pegasus'], ['Monoceros', 'Columba', 'Lyra', 'Hercules', 'Vela', 'Orion', 'Aquila', 'Monoceros', 'Draco', 'Hercules', 'Orion', 'Equuleus'], ['Vela', 'Aquila', 'Pegasus', ' Orion', 'Draco', 'Equuleus'], ['Lyra', 'Pegasus', ' Hercules', 'Monoceros', 'Aquila', 'Vela', 'Columba', 'Equuleus']]
var schools = ['Presbyterian Ladies’ College, Sydney', 'Brunei MOE‐Gifted Education Branch', 'The High School Affliated to Xi\'An Jiaotong University', 'The Second High School Attached to Beijing Normal University', 'Diocesan Girls\' School', 'Avicenna Cinere Senior High School', 'SMA Lazuardi Global Compassionate School', 'SMA Negeri 4 Denpasar High School', 'Aichi Prefectural Ichinomiya High School', 'Chung Ling High School', 'Sekolah Sultan Alam Shah', 'Philippine Science High School Main Campus', 'Anglican High School', 'CHIJ St. Theresa\'s Convent', 'CHIJ St. Nicholas Girls\' School', 'Dunman High School', 'Hwa Chong Institution', 'Methodist Girls\' School', 'Nan Chiau High School', 'Nanyang Girls\' High School', 'National Junior College', 'NUS High School of Math & Science', 'Raffles Girls\' School', 'Raffles Institution', 'River Valley High School', 'School of Science and Technology, Singapore', 'St. Joseph\'s Institution', 'St. Margaret\'s Secondary School', 'Temasek Junior College', 'Victoria Junior College', 'Xinmin Secondary School', 'Zhonghua Secondary School', 'Korea Science Academy of KAIST', 'Taipei Municipal Jianguo High School', 'Mahidol Wittayanusorn School', 'Hanoi-Amsterdam High School for the Gifted', 'High School for Gifted Students, Hanoi National University of Education']
